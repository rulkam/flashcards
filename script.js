...
const subjects = {
  "과학": {
    ...
    "기권과 날씨": [
      ...
      {
type: "choice",
front: "중간권에서는 대류가 일어나지 않아 기상현상이 일어나지 않는다.",
options: ["O","X"],
answer: "X",
explanation: "정답은 X입니다. 중간권은 대류가 일어나지만 수증기가 거의 없으므로 기상현상이 일어나지 않습니다."
},
{
type: "choice",
front: "(      )은 대기가 매우 안정적이라서 비행기의 항로가 된다.",
options: ["대류권","성층권","중간권","열권"],
answer: "성층권",
explanation: "정답은 성층권입니다. 성층권은 기온이 낮은 공기가 아래에 있고 기온이 높은 공기가 위쪽에 있으므로 대류가 일어나지 않아 대기가 안정적입니다."
},
{
type: "choice",
front: "온실효과를 일으키는 온실기체에는 수증기, 이산화탄소, 메테인이 있다.",
options: ["O","X"],
answer: "O",
...
{
type: "choice",
front: "지구가 흡수하는 태양 복사 에너지의 양과 지구가 우주로 방출하는 지구 복사 에너지의 양은 같다.",
options: ["O","X"],
answer: "O",
explanation: "정답은 O입니다. 지구는 흡수한 태양 복사 에너지와 같은 양의 지구 복사 에너지를 방출하여 복사 평형을 이룹니다. "
},
{
type: "choice",
front: "성층권에서는 태양복사 에너지의 직접적인 영향을 받아 기온이 높아진다.",
options: ["O","X"],
answer: "X",
explanation: "정답은 X입니다. 성층권은 오존이 태양에서 오는 자외선을 흡수하기 때문에 기온이 높아집니다."
},// 누군가의도움(복붙)
    ],
  },
};
